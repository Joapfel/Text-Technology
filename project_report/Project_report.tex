...
\end{figure}
In the previous section showed the speed, flexibility, and powerful search capabilities
...
and the ELK stack more broadly. In just a few pages we were able to take various raw data, manipulate them to
our liking, tease out both superficial and complex features thereof, and present it all in a manner
